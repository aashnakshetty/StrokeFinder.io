...
window.addEventListener("load", () => {
  ...
  const questions = [
    {
      text: "Specify your biological sex:",
      input: `
    ...
    {
      text: "Select the your age group:",
      input: `
        <label><input type="radio" name="age" value="18">Pediatric / Young Adult (0–21)</label>
        <label><input type="radio" name="age" value="35">Adult (21–45)</label>
        <label><input type="radio" name="age" value="55">Middle-aged (45–65)</label>
        <label><input type="radio" name="age" value="70">Geriatric (65+)</label>`
    },
    {
      text: "Select the your Body Mass Index (BMI):",
      input: `
        <label><input type="radio" name="bmi" value="30">≥ 30 (Obese)</label>
        <label><input type="radio" name="bmi" value="15"> ≤ 18.5 (Underweight)</label>
        <label><input type="radio" name="bmi" value="22">18.5–24.9 (Normal)</label>`
    },
    {
      text: "Select your residential environment:",
      input: `
    ...
    {
      text: "Indicate the patient's smoking history:",
      input: `
    ...
    {
      text: "Indicate your average glucose level (mg/dL):",
      input: `
        <label><input type="radio" name="avg_glucose_level" value="180">≥ 180 (Hyperglycemia)</label>
        <label><input type="radio" name="avg_glucose_level" value="100">< 180 (Normal / Controlled)</label>
        <label><input type="radio" name="avg_glucose_level" value="">Unknown / Not Tested</label>`
    },
    {
      text: "Have you been clinically diagnosed with hypertension?",
      input: `
        <label><input type="radio" name="hypertension" value="1"> Yes</label>
        <label><input type="radio" name="hypertension" value="0"> No</label>`
    },
    {
      text: "Has the patient been diagnosed with any cardiovascular disease?",
      input: `
  ...
  if (finalSubmitBtn) {
      finalSubmitBtn.addEventListener("click", (e) => {
        ...
        localStorage.setItem("strokeMode", "medical");
